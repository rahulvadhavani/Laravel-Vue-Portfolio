...
<head>
    ...
    <script>
        function navtoggle(){
            if($('#navigation').hasClass('showmenu')){
            ...
            <div id="sticky-header" class="main-header-area">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12">
                            <div class="d-lg-none">
                                <button onclick="navtoggle()" class="mobile_menu_bar  btn btn-dark text-white">button</button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="slider_area">
        <div class="single_slider  d-flex align-items-center slider_bg_1">
            <div class="shap_pattern d-none d-lg-block">
                <img src="{{asset('web-assets/img/about/grid.png')}}" alt="">
            </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-4">
                    <div class="single_service text-center">
                        <div class="icon">
                            <img src="{{asset('web-assets/img/svg_icon/1.svg')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_service text-center">
                        <div class="icon">
                            <img src="{{asset('web-assets/img/svg_icon/2.svg')}}" alt="">
                        </div>
                        <h3>Web design</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.</p>
                    </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="single_service text-center">
                        <div class="icon">
                            <img src="{{asset('web-assets/img/svg_icon/3.svg')}}" alt="">
                        </div>
                        <h3>Mobile app</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.</p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-md-5">
                    <div class="single_Portfolio">
                        <div class="portfolio_thumb">
                            <img src="{{asset('web-assets/img/portfolio/1.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-7 col-md-7">
                    <div class="single_Portfolio">
                        <div class="portfolio_thumb">
                            <img src="{{asset('web-assets/img/portfolio/2.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_Portfolio">
                        <div class="portfolio_thumb">
                            <img src="{{asset('web-assets/img/portfolio/3.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_Portfolio">
                        <div class="portfolio_thumb">
                            <img src="{{asset('web-assets/img/portfolio/4.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-12 col-lg-4">
                    <div class="single_Portfolio">
                        <div class="portfolio_thumb">
                            <img src="{{asset('web-assets/img/portfolio/5.png')}}" alt="">
                        </div>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="about_img">
                        <div class="color_pattern d-none d-lg-block">
                            <img src="{{asset('web-assets/img/about/color_grid.png')}}" alt="">
                        </div>
                        <div class="my_Pic">
                                <img src="{{asset('web-assets/img/about/about.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="testmonial_active owl-carousel">
                            <div class="single_carousel">
                                    <div class="single_testmonial text-center">
                                            <div class="quote">
                                                <img src="{{asset('web-assets/img/testmonial/quote.svg')}}" alt="">
                                            </div>
                                            ...
                                            <div class="testmonial_author">
                                                <div class="thumb">
                                                        <img src="{{asset('web-assets/img/testmonial/thumb.png')}}" alt="">
                                                </div>
