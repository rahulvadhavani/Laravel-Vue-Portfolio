                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                      ...
                      <input  wire:model="business" type="text" class="form-control">
                      @error('business') <span class="error text-danger err_margin">{{ $message }}</span> @enderror
                    </div>
                  </div>
                      ...
                      <div class="card-body">
                          <ul class="list-group">
                              ...
                              <li class="list-group-item">
                                  ...
                                  <p class="mb-0">{{$modalData->business ?? '-'}}</p>
                              </li>
                              <li class="list-group-item">
