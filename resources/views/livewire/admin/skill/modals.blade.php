                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                      ...
                      <input  wire:model="percentage" type="text" class="form-control">
                      @error('percentage') <span class="error text-danger err_margin">{{ $message }}</span> @enderror
                    </div>
                  </div>
                  <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                      ...
                      @error('color') <span class="error text-danger err_margin">{{ $message }}</span> @enderror
                    </div>
                  </div>
                      ...
                      <div class="card-body">
                          <ul class="list-group">
                              ...
                              <li class="list-group-item">
                                  ...
                                  <p class="mb-0">{{$modalData->percentage ?? '-'}}</p>
                              </li>
                              <li class="list-group-item">
                                  <small class="text-muted">Color: </small>
                                  <p style="color: {{$modalData->color ?? '-'}}" class="mb-0 p-1">{{$modalData->color ?? '-'}}</p>
                              </li>
                              <li class="list-group-item">
